...
namespace WebGuiaCesar
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //conection
            services.AddDbContext<AplicactionContext>(opt => opt.UseSqlServer(@"Server=LAPTOP-K7P699O5\SQLEXPRESS;Database=GuiaCesar;Trusted_Connection=True;"));
